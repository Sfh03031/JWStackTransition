...
public class JWStackTransitionAnimationAntiClockWise: JWStackTransitionAnimationDelegate {
    ...
    private var startAngle: Double = 1.5 // animation start angle
...
extension JWStackTransitionAnimationAntiClockWise {
    ...
    func makePath(_ endAngle: CGFloat) -> CGPath {
        ...
        path.addArc(withCenter: center, radius: CGFloat(radius), startAngle: CGFloat(self.startAngle * .pi), endAngle:CGFloat(endAngle), clockwise: true)
